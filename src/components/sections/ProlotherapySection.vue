    ...
    <div v-if="isOpen" class="video-modal-backdrop" @click.self="closeModal">
      <div class="video-modal" role="dialog" aria-modal="true" aria-label="Prolotherapy video">
        ...
        <p class="video-description">
          Our goal at Musculoskeletal Medicine PC, since 2001, is to properly evaluate and effectively treat
          acute and chronic pain. We specialize in multiple traditional as well as nontraditional, nonsurgical
          treatment options. Give us a call today or visit us online for more information.
        </p>
      </div>
    </div>
  </section>
